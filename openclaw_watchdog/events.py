...
def build_event_payload(
    *,
    ...
    return {
        ...
        'model_http_error_latest_at': str(run_state.get('model_http_error_latest_at', '') or ''),
        'model_http_error_latest_status': int(run_state.get('model_http_error_latest_status', 0) or 0),
        'model_failover_last_applied_at': str(run_state.get('model_failover_last_applied_at', '') or ''),
        'model_failover_last_from_model': str(run_state.get('model_failover_last_from_model', '') or ''),
        'model_failover_last_to_model': str(run_state.get('model_failover_last_to_model', '') or ''),
        'model_failover_last_status': str(run_state.get('model_failover_last_status', 'not-run') or 'not-run'),
        'model_failover_last_summary': str(run_state.get('model_failover_last_summary', '') or ''),
