...
def prometheus_metrics_text(metrics: dict[str, object]) -> str:
    ...
    lines = [
        ...
        "# HELP openclaw_watchdog_message_loop_probe_ready Whether the transport-level message loop probe observed a matching echo response.",
        "# TYPE openclaw_watchdog_message_loop_probe_ready gauge",
        f"openclaw_watchdog_message_loop_probe_ready {1 if metrics.get('message_loop_probe_ready', False) else 0}",
