...
run_capture "status-summary.txt" ./scripts/openclaw-watchdog-v2 status --summary
run_capture "status.json" ./scripts/openclaw-watchdog-v2 status --json
run_capture "report-message.txt" ./scripts/openclaw-watchdog-v2 report --message
run_capture "report.json" ./scripts/openclaw-watchdog-v2 report --json --limit 3
run_capture "metrics.json" ./scripts/openclaw-watchdog-v2 metrics --json
run_capture "metrics.prom" ./scripts/openclaw-watchdog-v2 metrics --prometheus
run_capture "incidents-list.txt" ./scripts/openclaw-watchdog-v2 incidents list --limit 5
if ! ./scripts/openclaw-watchdog-v2 incidents current --json > "$OUT_DIR/incidents-current.json"; then
  printf '{}
