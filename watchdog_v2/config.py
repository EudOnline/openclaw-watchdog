...
class Config:
    ...
    def load(cls, env_file: Path | None = None) -> "Config":
        ...
        return cls(
            ...
            openclaw_config=_env_path(raw, "OPENCLAW_CONFIG", "/root/.openclaw/openclaw.json"),
            ...
            watchdog_state_dir=_env_path(raw, "WATCHDOG_STATE_DIR", "/root/.openclaw-backup/watchdog"),
            watchdog_log_file=_env_path(raw, "WATCHDOG_LOG_FILE", "/root/.openclaw-backup/watchdog/watchdog.log"),
            watchdog_event_file=_env_path(raw, "WATCHDOG_EVENT_FILE", "/root/.openclaw-backup/watchdog/last-event.txt"),
            watchdog_event_history_file=_env_path(raw, "WATCHDOG_EVENT_HISTORY_FILE", "/root/.openclaw-backup/watchdog/event-history.jsonl"),
            watchdog_event_history_limit=max(1, _env_int(raw, "WATCHDOG_EVENT_HISTORY_LIMIT", 20)),
            watchdog_run_state_file=_env_path(raw, "WATCHDOG_RUN_STATE_FILE", "/root/.openclaw-backup/watchdog/run-state.json"),
            watchdog_last_good_config=_env_path(raw, "WATCHDOG_LAST_GOOD_CONFIG", "/root/.openclaw-backup/watchdog/openclaw.last-good.json"),
            watchdog_last_rollback_summary_file=_env_path(raw, "WATCHDOG_LAST_ROLLBACK_SUMMARY_FILE", "/root/.openclaw-backup/watchdog/last-rollback-summary.txt"),
            watchdog_rollback_archive_dir=_env_path(raw, "WATCHDOG_ROLLBACK_ARCHIVE_DIR", "/root/.openclaw-backup/watchdog/rollback-archives"),
            watchdog_incidents_dir=_env_path(raw, "WATCHDOG_INCIDENTS_DIR", "/root/.openclaw-backup/watchdog/incidents"),
            watchdog_incident_index_file=_env_path(raw, "WATCHDOG_INCIDENT_INDEX_FILE", "/root/.openclaw-backup/watchdog/incident-index.json"),
            watchdog_incident_index_limit=max(1, _env_int(raw, "WATCHDOG_INCIDENT_INDEX_LIMIT", 20)),
            watchdog_last_report_file=_env_path(raw, "WATCHDOG_LAST_REPORT_FILE", "/root/.openclaw-backup/watchdog/last-report.json"),
            watchdog_last_metrics_file=_env_path(raw, "WATCHDOG_LAST_METRICS_FILE", "/root/.openclaw-backup/watchdog/last-metrics.json"),
            watchdog_failure_count_file=_env_path(raw, "WATCHDOG_FAILURE_COUNT_FILE", "/root/.openclaw-backup/watchdog/consecutive-failures"),
            watchdog_maintenance_file=_env_path(raw, "WATCHDOG_MAINTENANCE_FILE", "/root/.openclaw-backup/watchdog/maintenance-mode"),
            watchdog_codex_last_trigger_file=_env_path(raw, "WATCHDOG_CODEX_LAST_TRIGGER_FILE", "/root/.openclaw-backup/watchdog/codex-last-trigger"),
            watchdog_lock_file=_env_path(raw, "WATCHDOG_LOCK_FILE", "/root/.openclaw-backup/watchdog/watchdog.lock"),
            ...
            watchdog_restart_wait_seconds=_env_int(raw, "WATCHDOG_RESTART_WAIT_SECONDS", 8),
            ...
            watchdog_service_level_timeout_seconds=max(1, _env_int(raw, "WATCHDOG_SERVICE_LEVEL_TIMEOUT_SECONDS", 5)),
            watchdog_service_level_retry_grace_seconds=max(0, _env_int(raw, "WATCHDOG_SERVICE_LEVEL_RETRY_GRACE_SECONDS", 5)),
            ...
            watchdog_survival_config_file=_env_path(raw, "WATCHDOG_SURVIVAL_CONFIG_FILE", "/root/.openclaw-backup/watchdog/openclaw.survival.json"),
            watchdog_survival_state_file=_env_path(raw, "WATCHDOG_SURVIVAL_STATE_FILE", "/root/.openclaw-backup/watchdog/survival-mode.json"),
            ...
            watchdog_enable_pre_repair_backup=_env_bool(raw, "WATCHDOG_ENABLE_PRE_REPAIR_BACKUP", True),
            watchdog_backup_script=_env_path(raw, "WATCHDOG_BACKUP_SCRIPT", "/root/.openclaw/workspace/tools/openclaw-backup.js"),
            watchdog_backup_env_file=_env_path(raw, "WATCHDOG_BACKUP_ENV_FILE", "/root/.openclaw/workspace/config/openclaw-backup.env"),
            ...
            watchdog_last_good_manifest_file=_env_path(raw, "WATCHDOG_LAST_GOOD_MANIFEST_FILE", "/root/.openclaw-backup/watchdog/last-good-manifest.json"),
            watchdog_last_good_generations=max(1, _env_int(raw, "WATCHDOG_LAST_GOOD_GENERATIONS", 5)),
            watchdog_guard_manifest_file=_env_path(raw, "WATCHDOG_GUARD_MANIFEST_FILE", "/root/.openclaw-backup/watchdog/drift-guard.json"),
            ...
            watchdog_enable_codex_autorun=_env_bool(raw, "WATCHDOG_ENABLE_CODEX_AUTORUN", True),
            watchdog_codex_bin=_env(raw, "WATCHDOG_CODEX_BIN", "/usr/bin/codex"),
            watchdog_codex_model_hint=_env(raw, "WATCHDOG_CODEX_MODEL_HINT", "gpt-5.4-xhigh"),
            watchdog_codex_workdir=_env_path(raw, "WATCHDOG_CODEX_WORKDIR", "/root"),
            ...
            watchdog_opencode_fallback_workdir=_env_path(raw, "WATCHDOG_OPENCODE_FALLBACK_WORKDIR", "/root"),
